...
Tal boceto fue agregado, en formato JPG o PNG, al `README.md` de un repositorio de organización (recuerden que pueden optimizar tales formatos con [opciones de Photoshop](https://helpx.adobe.com/es/photoshop-elements/using/optimizing-images.html), [Squoosh](https://squoosh.app/) o [TinyPNG](https://tinypng.com/)).  
