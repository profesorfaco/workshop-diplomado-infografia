...
**Dos pruebas rápidas para revisar la accesibilidad en cualquier sitio web:**
...
**Si se cuenta con más tiempo, podemos evitar las pruebas rápidas (y extremas) recién mencionadas. Podríamos usar [WAVE: Web Accessibility Evaluation Tool](https://wave.webaim.org/)**.
...
También es probable que el reporte de LightHouse dé indicaciones respecto del SEO, porque las máquinas necesitan datos o, mejor dicho, metadatos. Con ellos pueden catalogar lo que ustedes publican en línea. Para cuidar los metadatos, es recomendable:
